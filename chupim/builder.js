...
const builder = {
    ...
    createSimpleSerialPipeline: function(stages){
        return (c) => pipeline
            .serialPipeline(c, ...this.getStagesByName(stages)).catch(c => console.log(c));
    },
    ...
    component: function(config){
        ...
        return async (context) => {
          ...
          console.log(context);
          Object.assign(context._chupim_.query, context.query);

          await fn(context);
          context._chupim_.metadata.totalTime = new Date() - elapsedTime;
          //console.log(context);

          if(context._chupim_.query['chupim.debug'] != 'true'){
